...
import com.example.perpustakaan.entity.BaseEntity;
...
public class BaseDAO<T extends BaseEntity<T>> {
    ...
    public T findOne(T param){
        ...
        return singleResult(query, predicates(param, builder, root, isCount: false));
    }
    ...
    public Collection<T> find(T param, int offset, int limit){
        ...
        return listResult(query, predicates(param, builder, root, isCount false), offset, limit);
    }
    ...
    public Long count(T param){
        ...
        return singleResult(query, predicates(param, builder, root, isCount true));
    }
